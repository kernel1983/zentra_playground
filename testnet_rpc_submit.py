...
if __name__ == '__main__':
    if len(sys.argv) < 3:
        print('Usage: python testnet_rpc_submit.py <accounts.json> <slug>')
        print('Example: python testnet_rpc_submit.py accounts.json btc_5min_202609090120')
        sys.exit(1)
    ...
    print(f'  BTC=${current_price:,.2f} vs target=${target_price:,.2f} -> {winner}')
